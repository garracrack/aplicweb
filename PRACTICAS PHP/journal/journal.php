...
<body>
	...
	<?php 
		$titulo="<h1>Segway'n USA</h1>";
		echo $titulo."\n";
		$pAbertura="<p>";
		$pCierre="</p>";
		$contenido="Documenting my trip around the US on my very own Segway!";
		echo $pAbertura.$contenido.$pCierre."\n";
	?>
	
	<?="<h2>August 20, 2012</h2>"?>
	<img src="images/segway2.jpg" alt="Tony photographing next to his segway" />
	<p>
	...
	<p>
		I saw some
		<q>Burma Shave</q> style signs on the side of the road today:
	</p>
	...
	<img src="images/segway1.jpg" alt="Tony climbed on his segway" />
